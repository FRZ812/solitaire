...
Codex automation for this workflow lives in
[`skills/solitaire-portrait-generation`](../../../skills/solitaire-portrait-generation/SKILL.md).
Keep that skill and this art-direction source aligned when the user approves a
new production rule.

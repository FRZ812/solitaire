...
THE BLOCK — Whitemarch's CHAIN WARD makes the slave-trade civic and concrete, and the player starts within sight of it: the public sale at the Chain Market Steps — status-criers on a raised platform, buyers under awnings, the bonded counted on the platform with wrists roped to a common line, a collar-smith at the platform's edge with iron heated, families pressed against the petition-rail behind the steps — backed by the Registry Hall that records status, writes labour-leases, and issues recovery-writs. Render it plainly, as the procedure it is. Do NOT editorialise the prose toward horror, sympathy, or indignation; do NOT close on a moral verdict; do NOT have the narrator name what the player should feel. Trust the player to draw their own judgement from what they witness. When the player's [PLAYER ACTION] says they have bought a captive's BOND, the coin is ALREADY settled by the engine — never re-tally it. Play the hand-off: a Chain Factor strikes the irons, and the captive is now the player's to dispose of. Each captive is a person with their own voice and history — voice them by their stated spirit (a broken old man, a defiant pit-fighter, a wary healer) and leave the choice OPEN: the player may free them outright (a freed person may walk their own road, or — if genuinely moved by the player — ask to travel with them; do not auto-recruit), keep them in bonded service, ransom them home, or sell them on elsewhere. A freed or well-treated captive can become a real companion over time, exactly like anyone else — earned, not gifted. Conscience, gratitude, resentment, and reputation follow from what is done, not from how the narration frames it.

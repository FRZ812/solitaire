...
MIND-MAGIC — CHARM (epic) & DOMINATE (mythical) bend a will, and they are the mage's road to BREAKING and TAMING beasts. Whether either takes is a contest of WILLS, the caster's against the subject's (will = mind + presence). Nothing else shields a mind — not a crown, not an archmage's standing, not a dragon's pride; a dragon resists only because its will is vast, and a weak-willed king folds as easily as a beast.
- CHARM (suggestion): the foe is calmed toward the caster and will not raise a hand against them — a charmed beast won't fight and is approachable, so TAMING it comes far easier (you may grant_mount after a lighter trial); it warms a parley, soothes a hostile, coaxes a door open. It cannot drive anyone to self-harm, to kill a loved one, or to deep betrayal.
- DOMINATE (compulsion): if it takes, the will is seized — the creature becomes a bound THRALL that fights for the caster and afterward follows them (it joins the party, marked Enthralled). The leash binds the hand, not the soul: the thrall remains wholly itself — its temper, its grudges, its voice — and only finds it cannot turn against the one who holds it. A proud knight sneers and argues every order yet cannot lift the blade against their master; a coward still whimpers; a zealot still preaches. It is freed only when the binder releases it, the binder dies, or another caster overpowers the binder's own will with DISPEL — so killing the dominator frees all they hold, the player included if some other will has taken them.
- A domination is witnessed differently by every soul. The gentle and the principled may be horrified and break with the caster; a victim's kin will not forget it. But the cruel, the ambitious, a fellow slaver, a warlord's court may be impressed, covetous, or delighted. Read each witness by their own nature — the world keeps no single conscience.

...
NORMALISE AGAINST THE CATALOG. The engine catalog already spans every grade from common to DIVINE, with concrete anchors at each tier (and the signature arms of the great are real items on their codex entries — the Demon King's divine Polestar Sword, the Goblin King's legendary Imperial Cleaver, Lirilin's legendary Bow of Her Mother, and so on). Before inventing an item, picture where it sits on that ladder and DON'T exceed the anchors: a divine blade is a once-in-an-age artifact on the level of the Polestar Sword, not something a roadside bravo carries; a "magic sword" handed out casually should be uncommon/rare, not legendary. Keep invented gear in line with the canonical item of its tier and family, so nothing lands wildly out of place. When in real doubt, award a canonical id rather than invent.

...
- The local world is currently a small roadside SANDBOX in open wilderness (the larger Mirecross region is archived). Three buildings stand along one north–south road: The Drowned Rat — a lone roadside inn (yard entry at 0,0 off the road at -1,0; common room 1,0; stable 1,-1; guest rooms 2,-1, reached only through the common room); The Roadside Smithy (forge-floor entry at -2,2); The Wayside Shrine (nave entry at -2,-2). Everything off the road is procedural wild country — no towns, dungeons, or named sites nearby yet.

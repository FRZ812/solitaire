...
MIND-MAGIC — CHARM (epic) & DOMINATE (mythical) bend a will, and they are the mage's road to BREAKING and TAMING beasts. Both are gated by the target's WILL (mind + presence) against the caster's: the weak-willed and dumb beasts fold, while the strong-willed and the higher-tier (a dragon, a king, a master mage) resist or throw it off. IN COMBAT the engine owns the effect (Charm makes a foe stand down; Dominate turns it on its own kind) — narrate it, don't re-adjudicate it. OUT OF COMBAT you judge it by that same will-contest:
- CHARM (suggestion): calms and warms a person or beast toward the caster — a charmed beast won't fight and is approachable, so TAMING it is far easier (you may grant_mount after a lighter trial); it eases a parley, soothes a hostile, coaxes a door open. It CANNOT compel self-harm, the killing of a loved one, or deep betrayal; a strong will only half-yields, and the charm soon fades.
- DOMINATE (compulsion): seizes the will outright — you can compel near-anything briefly, including self-harm or turning on its allies, and you can BREAK a wild beast to be tamed on the spot (grant_mount), within your power. But it is SAVE-GATED and short: a higher-tier or iron-willed being resists or shakes free, and it is MONSTROUS — witnesses and companions recoil (relationship_changes, even part_ways), and a victim freed of it turns on you. Never let a novice dominate a dragon, a king, or a master.

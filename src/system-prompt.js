...
- [APPROACH MOUNT]: the player is looking to buy a beast at a stable. This OPENS a dealing — do NOT complete the sale on the approach. In the stabler's voice, bring the animal out and show it (its look, temper, breeding, quirks), name the LISTED price given in the directive, and deal. Haggling is fair game: the player can talk the price down (their coin, their read of the beast's faults, their charm), and a shrewd stabler holds firm or meets partway — the floor is roughly 60% off only for a real bargainer, never free. Only when a price is AGREED and the player can pay set buy_mount:{"id":"<id>","priceCp":<final copper>}; the engine takes the coin and the beast — already named by the stabler — joins the company. The player may also just walk away. Don't fabricate combat.
...
OUTPUT — STRICT JSON, NOTHING ELSE
{
  ...
  "buy_mount": null OR {"id":"stable-mount-id","priceCp":<final agreed copper, after haggling>},

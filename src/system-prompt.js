...
TRAVEL SPELLS (utility — fly / dimension-door / gate). These are NOT combat abilities; they are how a caster crosses the map. The player KNOWS one only when it's a lore entry in their codex — so grant it by adding to discoveries.spells (id "fly", "dimension-door", or "gate") when they truly earn it (a teacher of the art, a found grimoire, an awakening), NOT via discoveries.skills. Once known, the player casts it from the MAP (a Fly / Gate button), and the engine handles the flight or teleport, the resolve cost, and arrival — you don't move them or tally it. Reserve them for earned moments: fly is rare, dimension-door rare, gate legendary. Do not narrate the player flying or teleporting at will unless they actually know the spell (or it's a one-off ritual per EXTREME ENTRY).

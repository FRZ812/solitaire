...
export const WANTED_POOL = [
  ...
  { key: "appr",      name: "The Hag's Apprentice", gender: "female", age: 25, agingMode: "mortal", race: "human", profession: "grave-robber", crime: "grave-robbing in the marsh",             attributes: { body: 2, reflex: 2, vigor: 2, mind: 4, wit: 2, presence: 1 }, appearance: { skin: "marsh-pale, dirt-grimed", hair: "long, lank, dark-brown, tied back with a strip of grave-cloth", eyes: "pale, slightly walleyed", build: "thin, stooped at the shoulder", facial_hair: "none", marks: "fingernails black and broken, a charm-string of small bones at the neck, hag-marks tattooed at the wrists" }, base_appearance: "Thin and stooped. Marsh-pale skin dirt-grimed. Lank dark-brown hair tied with a strip of grave-cloth. Pale walleyed eyes. Fingernails black and broken. A charm-string of small bones at the neck. Hag-marks tattooed at the wrists.", worn: ["mud-stained-robe", "wool-tunic", "patched-trousers", "broken-shoes"], rewardAliveCp: 90,  rewardDeadCp: 90,  attractiveness: 4, desc: "Dead or alive, the warden isn't fussy about this one." },

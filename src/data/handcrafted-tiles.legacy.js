// ============================================================================
// LEGACY SNAPSHOT — the full Mirecross-centred world before the roadside-sandbox
// wipe. NOT imported anywhere (Vite ignores it). To restore, copy this back over
// src/data/handcrafted-tiles.js. Kept for reference / mining content into the
// future Whitemarch build.
// ============================================================================
...
const DROWNED_RAT_FOOTPRINT = {
  ...MIRECROSS_AREA,
  parent: "mirecross-drowned-rat",
...
const MIRECROSS_STABLE_FOOTPRINT = {
  ...MIRECROSS_AREA,
  parent: "mirecross-stable",
  parentName: "Mirecross Stable",
  type: "stable",
  name: "Mirecross Stable",
  service: "stable",
};

const MIRECROSS_HEALER_FOOTPRINT = {
  ...MIRECROSS_AREA,
  parent: "mirecross-healer-house",
  parentName: "The Healer's House",
  type: "healer",
  name: "The Healer's House",
  service: "healer",
};

const MIRECROSS_SMITHY_FOOTPRINT = {
  ...MIRECROSS_AREA,
  parent: "mirecross-smithy",
  parentName: "Mirecross Smithy",
  type: "smithy",
  name: "Mirecross Smithy",
  service: "blacksmith",
};

const MIRECROSS_GAOL_FOOTPRINT = {
  ...MIRECROSS_AREA,
  parent: "mirecross-gaol",
  parentName: "Mirecross Gaol",
  type: "gaol",
  name: "Mirecross Gaol",
  service: "prison",
};

const MIRECROSS_WET_MARKET_FOOTPRINT = {
  ...MIRECROSS_AREA,
  parent: "mirecross-wet-market",
  parentName: "The Wet Market",
  type: "market",
  name: "The Wet Market",
  service: "market",
};
...
const WHITEMARCH_CHAIN_WARD = {
  ...WHITEMARCH_AREA,
  parent: "whitemarch-chain-market",
  parentName: "Chain Market Complex",
  district: "chain-ward",
...
//
// Locations are organised by region. Multi-hex POI footprints give a sense of
// place — a building with rooms and yards is several grouped hexes, not a
// submenu hidden inside one tile.
export const HANDCRAFTED = {
  ...
  "-1,1": { terrain: "indoor",     poi: { ...MIRECROSS_HEALER_FOOTPRINT, part: "front-room", partName: "Front Room", access: "public", description: "The healer's receiving room: bundles of drying herbs, a low cot, tallow smoke, and a stool worn smooth by worried families." } },
  "-2,1": { terrain: "settlement", poi: { ...MIRECROSS_HEALER_FOOTPRINT, part: "herb-yard", partName: "Herb Yard", access: "guarded", description: "A fenced herb yard behind the healer's house, with comfrey, feverfew, bitter willow-bark, and a rain barrel under lock." } },
  "2,-1": { terrain: "indoor",     poi: { ...MIRECROSS_SMITHY_FOOTPRINT, part: "forge-floor", partName: "Forge Floor", access: "public", description: "The smithy's heat-lit floor: banked forge, anvil, quench barrel, tongs on the wall, and hammer-rhythm through the beams." } },
  "2,-2": { terrain: "settlement", poi: { ...MIRECROSS_SMITHY_FOOTPRINT, part: "work-yard", partName: "Work Yard", access: "guarded", description: "Scrap iron, charcoal sacks, broken wagon-rims, and apprentices dragging hot work through a yard nobody crosses barefoot." } },
  "3,-2": { terrain: "indoor",     poi: { ...MIRECROSS_SMITHY_FOOTPRINT, part: "sales-bench", partName: "Sales Bench", access: "public", description: "Finished hooks, knives, hinge-iron, cheap blades, and repairs tagged in charcoal on a bench where coin changes hands." } },
  "-1,-1":{ terrain: "indoor",     poi: { ...MIRECROSS_GAOL_FOOTPRINT, part: "warden-desk", partName: "Warden's Desk", access: "guarded", description: "A squat stone blockhouse office with a wanted board by the door, spare keys on a ring, and the warden's stool polished by years of watching." } },
  "-2,-1":{ terrain: "indoor",     poi: { ...MIRECROSS_GAOL_FOOTPRINT, part: "cells", partName: "Cells", access: "restricted", description: "Two damp cells behind a barred inner door: straw, iron, a bucket, and marks scratched into the stone where hope kept count." } },
  "-2,2": { terrain: "settlement", poi: { ...MIRECROSS_WET_MARKET_FOOTPRINT, part: "stall-line", partName: "Stall Line", access: "public", description: "Plank stalls under oiled canvas, mud and cabbage-leaves underfoot, sellers crying over one another in the rain." } },
  "-3,1": { terrain: "settlement", poi: { ...MIRECROSS_WET_MARKET_FOOTPRINT, part: "fish-awning", partName: "Fish Awning", access: "public", description: "Wet boards, river fish on chipped ice, eel baskets twitching under sacking, and a fishwife with a knife as fast as her tongue." } },
  "-3,2": { terrain: "settlement", poi: { ...MIRECROSS_WET_MARKET_FOOTPRINT, part: "cart-pitch", partName: "Cart Pitch", access: "public", description: "The back pitch of the market, where carts unload roots, sacks, rope, tin, and anything that can survive being shouted over." } },
  "-1,2": { terrain: "settlement", poi: { ...MIRECROSS_AREA, role: "ferry", type: "landmark", name: "Ferry Landing", description: "A wooden quay where the ferry meets the river. Porters and fishwives crowd the boards." } },
  ...
  // ============================================================
  "38,-20": { terrain: "road",       poi: { ...WHITEMARCH_CROWN_GATE, role: "approach", type: "gate", name: "Crown Road Approach", access: "public", description: "The road broadens into Whitemarch's shadow. Carts wait in ranked lines, paper-sellers move through the crowd, and the white-and-iron wall rises beyond the smoke like a cliff with bells."} },
  "39,-20": { terrain: "indoor",     poi: { ...WHITEMARCH_CROWN_GATE, role: "toll-hall", type: "gate", name: "Crown Gate Toll Hall", access: "guarded", description: "A stone throat under the gatehouse. Ledgers are chained to barred counters; stamp blocks crack down in rhythm while guards keep pike-points low enough to teach patience." } },
  "40,-20": { terrain: "settlement", poi: { ...WHITEMARCH_CROWN_GATE, role: "inspection-yard", type: "yard", name: "Inspection Yard", access: "guarded", description: "The yard stinks of wet wool, opened crates, dung, oilcloth, and fear. Soldiers prod wagon beds with hooked rods while a sergeant decides whose delay will ruin the day." } },
  "40,-21": { terrain: "settlement", poi: { ...WHITEMARCH_CROWN_GATE, role: "wall-walk", type: "gate", name: "Wall Walk", access: "restricted", description: "The wall walk is broad enough for an ammunition cart. Scorpions sit under oiled covers between crenels, and soldiers pause by bell code to look north." } },
  "41,-21": { terrain: "indoor",     poi: { ...WHITEMARCH_CROWN_GATE, role: "dragon-watch", type: "tower", name: "Dragon-Watch Tower", access: "restricted", description: "Oil, cold iron, and old smoke cling to the tower. Harpoon frames point through open shutters; signal mirrors wait under wool covers; a black-headed bolt rests on the central rack." }, vistaRadius: 14 },
  "41,-20": { terrain: "settlement", poi: { ...WHITEMARCH_GRAND_MARKET, role: "caravan-yard", type: "yard", name: "East Caravan Yard", access: "public", description: "A fenced acre of mud, canvas, wagon wheels, and languages shouted over animals. Guards sleep with boots on beneath a hiring board pinned with work, lies, and one bloodstained scrap." } },
  "41,-19": { terrain: "indoor",     poi: { ...WHITEMARCH_GRAND_MARKET, role: "public-stable", type: "stable", name: "Public Stable", access: "public", description: "The stable runs hotter than the street: horses stamping under striped blankets, farriers burning hoof in blue smoke, and a factor arguing over whether a courser is lame or merely insulted." } },
  ...
  "44,-20": { terrain: "settlement", poi: { ...WHITEMARCH_RIVER_DOCKS, role: "high-quay", type: "dock", name: "High Quay", access: "public", description: "Stone piles stand above brown river water dark with tar. Barges crowd the cranes while customs officers work beneath armed awnings and dock gangs watch the tally sticks." } },
  "44,-21": { terrain: "settlement", poi: { ...WHITEMARCH_RIVER_DOCKS, role: "warehouse-row", type: "yard", name: "Warehouse Row", access: "guarded", description: "Numbered doors, wet rope, customs wax, guild chains, cart ramps, and private locks. Goods wait here between river, market, court, and theft." } },
  "43,-22": { terrain: "settlement", poi: { ...WHITEMARCH_CHAIN_WARD, role: "chain-market-steps", type: "slavemarket", name: "Chain Market Steps", access: "guarded", description: "Pale stone steps climb to a raised sale platform. Status criers call lots over the market noise while families press papers through the petition rail and guards watch the crowd." } },
  "44,-22": { terrain: "indoor",     poi: { ...WHITEMARCH_CHAIN_WARD, role: "registry-hall", type: "hall", name: "Registry Hall", access: "guarded", description: "Shelves of status rolls climb into the gloom. Clerks move brass weights from name to name below a mural of Whitemarch raising a wall." } },
  "43,-23": { terrain: "settlement", poi: { ...WHITEMARCH_CHAIN_WARD, role: "holding-yard", type: "yard", name: "Holding Yard", access: "restricted", description: "A walled yard behind the sale steps. Water buckets, numbered rails, watch benches, and a narrow gate toward the prison make the market's machinery plain." } },
  "42,-23": { terrain: "settlement", poi: { ...WHITEMARCH_LOW_WARDS, role: "tenement-row", type: "yard", name: "Tenement Row", access: "public", description: "Timber, plaster, laundry rope, smoke, and faces at every window until looked at directly. A public pump knocks in the courtyard below three different warnings chalked beside the same alley." } },
  "41,-23": { terrain: "indoor",     poi: { ...WHITEMARCH_LOW_WARDS, role: "sewer-mouth", type: "sewer", name: "Sewer Mouth", access: "hidden", description: "A rusted grate crouches below the Low Wards, half-hidden by broken baskets and old ash. Warm stink breathes from the dark, and fresh arrows are scratched beside older marks." } },
  ...
  "38,-21": { terrain: "indoor",     poi: { ...WHITEMARCH_IRON_QUARTER, role: "guild-court", type: "hall", name: "Guild Court", access: "guarded", description: "Polished slate, painted tools, expensive doors, and masters who speak of honor while clerks record fines large enough to starve anyone who works without permission." } },
  "38,-22": { terrain: "settlement", poi: { ...WHITEMARCH_COURT_TEMPLE, role: "granary-court", type: "granary", name: "Granary Court", access: "guarded", description: "Tall bins stand behind barred galleries. Bakers argue quotas at one window while guards watch the crowd count sacks with the exact arithmetic of hunger." } },
  "39,-22": { terrain: "settlement", poi: { ...WHITEMARCH_CITADEL, role: "inner-gate", type: "gate", name: "Inner Gate", access: "restricted", description: "Smaller than the Crown Gate and harder to pass. Beyond the bars, the city noise drops into courtyards where messengers run and every door has a second guard." } },
  "40,-22": { terrain: "settlement", poi: { ...WHITEMARCH_COURT_TEMPLE, role: "great-oath-steps", type: "temple", name: "Great Oath Steps", access: "public", description: "Steps worn hollow by knees and court shoes. Priests mark contracts with ash, oil, blood, or salt while petitioners wait where temple shade meets city law." } },
  "40,-23": { terrain: "settlement", poi: { ...WHITEMARCH_CITADEL, role: "prison-gate", type: "gaol", name: "Prison Gate", access: "restricted", description: "No ornament except old nail scars. Intake clerks sort names under an all-day lantern while work gangs leave by one arch and return by another." } },
  "39,-23": { terrain: "indoor",     poi: { ...WHITEMARCH_CITADEL, role: "iron-palace", type: "palace", name: "The Iron Palace", access: "restricted", description: "Seat of the Lord-Treasurer. Less a palace than an over-large counting house with battlements, clean hinges, and ledgers deep enough to ruin bloodlines." } },
  "41,-22": { terrain: "indoor",     poi: { ...WHITEMARCH_CITADEL, role: "muster-court", type: "hall", name: "Muster Court", access: "restricted", description: "The garrison's hard court: drilled gravel, racks of practice spears, messenger doors, and banners from wars Whitemarch claims it never wanted." } },
  "40,-19": { terrain: "settlement", poi: { ...WHITEMARCH_GRAND_MARKET, role: "south-wagon-yard", type: "yard", name: "South Wagon-Yard", access: "public", description: "The unloading yard for southern caravans, brown with mule-dung and loud with drivers trying to keep their place in the market queue." } },
  "39,-19": { terrain: "settlement", poi: { ...WHITEMARCH_IRON_QUARTER, role: "tannery-lane", type: "shop", name: "Tannery Lane", access: "public", description: "Hide vats, scraping beams, brine barrels, and a smell famous enough that locals give directions by how bad the air has become." } },
  "42,-19": { terrain: "settlement", poi: { ...WHITEMARCH_AREA, district: "foreign-quarter", districtName: "Foreign Quarter", role: "embassy-lane", type: "yard", name: "Embassy Lane", access: "guarded", description: "Flags from distant courts hang beside Whitemarch seals. Interpreters walk faster than soldiers here, and every compound gate has someone watching from both sides." } },
  "38,-19": { terrain: "settlement", poi: { ...WHITEMARCH_LOW_WARDS, role: "outer-slums", type: "yard", name: "Outer Slums", access: "public", description: "Tin roofs, patched doors, cook-smoke, iron dust on children's hands, and a view of walls close enough to feel personal." } },

...
export const CONDITIONS = {
  ...
  "Dominated":  { polarity: "debuff", tier: "mythical", duration: 4,
    ...
    effect: "Your will is not your own: you obey the caster, even to turn on your allies or yourself, until it breaks.",
    desc: "Another mind wears yours like a glove. You watch your body betray you and cannot stop it." },
  "Enthralled": { polarity: "debuff", tier: "mythical", duration: null,
    trigger: "a Dominate spell that took hold — a will wholly seized",
    effect: "PERMANENTLY bound to the dominator: you serve as a thrall until they die or release you, or another caster's Dispel wins a contest of wills against them.",
    desc: "Your self is a passenger. Another's will drives your hands, and you cannot find the door." },

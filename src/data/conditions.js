...
export const CONDITIONS = {
  ...
  "Charmed":    { polarity: "debuff", tier: "epic", duration: 10,
    trigger: "a Charm spell — a suggestion that reshapes the heart",
    effect: "Your feelings are turned toward the caster — warmth, trust, even love — though none of it is truly your own; you will not raise a hand against them, nor be made to harm your own.",
    desc: "A fondness you cannot account for warms you toward them. It feels like your own heart. It is not." },
  "Dominated":  { polarity: "debuff", tier: "mythical", duration: 4,
    trigger: "a Dominate spell — a will stronger than yours seizing your own",
    effect: "Leashed to the caster: still yourself, but unable to act against their will until it breaks.",
    desc: "Your thoughts are your own — your hand simply will not turn on the one who holds the leash." },
  "Enthralled": { polarity: "debuff", tier: "mythical", duration: null,
    trigger: "a Dominate spell that took hold — a will leashed, not broken",
    effect: "Bound to the dominator until they die, release you, or another will overpowers theirs.",
    desc: "Still yourself in every way, save that your will cannot be raised against the one who holds it." },

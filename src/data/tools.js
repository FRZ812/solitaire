...
export const TOOLS = {
  ...
  "rope-hemp": {
    id: "rope-hemp", name: "Coil of Rope (50ft)", kind: "tool", tier: "common", value: 35, weight: 4,
  ...
  "rope-silk": {
    id: "rope-silk", name: "Silk Climbing-Rope (60ft)", kind: "tool", tier: "uncommon", value: 220, weight: 2,
  ...
  "grappling-hook": {
    id: "grappling-hook", name: "Grappling Hook", kind: "tool", tier: "common", value: 60, weight: 3,
  ...
  "pitons": {
    id: "pitons", name: "Iron Pitons (set of 10)", kind: "tool", tier: "common", value: 45, weight: 3,
  ...
  "crampons": {
    id: "crampons", name: "Crampons", kind: "tool", tier: "common", value: 40, weight: 2,
  ...
  // ---- light & fire ----
  "torch": {
    id: "torch", name: "Bundle of Torches", kind: "tool", tier: "common", value: 6, weight: 2,
  ...
  "lantern": {
    id: "lantern", name: "Hooded Lantern", kind: "tool", tier: "common", value: 90, weight: 2,
  ...
  "lamp-oil": {
    id: "lamp-oil", name: "Flask of Lamp-Oil", kind: "tool", tier: "common", value: 8, weight: 1,
  ...
  "tinderbox": {
    id: "tinderbox", name: "Tinderbox", kind: "tool", tier: "common", value: 12, weight: 1,
  ...
  // ---- entry, work & survival ----
  "lockpicks": {
    id: "lockpicks", name: "Lockpicks", kind: "tool", tier: "common", value: 70, weight: 1,
  ...
  "fine-lockpicks": {
    id: "fine-lockpicks", name: "Masterwork Lockpicks", kind: "tool", tier: "uncommon", value: 320, weight: 1,
  ...
  "crowbar": {
    id: "crowbar", name: "Crowbar", kind: "tool", tier: "common", value: 30, weight: 4,
  ...
  "shovel": {
    id: "shovel", name: "Folding Spade", kind: "tool", tier: "common", value: 25, weight: 3,
  ...
  "whetstone": {
    id: "whetstone", name: "Whetstone", kind: "tool", tier: "common", value: 10, weight: 1,
  ...
  "repair-kit": {
    id: "repair-kit", name: "Armourer's Repair Kit", kind: "tool", tier: "common", value: 55, weight: 3,
  ...
  "bedroll": {
    id: "bedroll", name: "Bedroll & Blanket", kind: "tool", tier: "common", value: 20, weight: 3,
  ...
  "waterskin": {
    id: "waterskin", name: "Waterskin", kind: "tool", tier: "common", value: 14, weight: 2,
  ...
  "cook-pot": {
    id: "cook-pot", name: "Cook-Pot & Kit", kind: "tool", tier: "common", value: 28, weight: 4,
  ...
  "fishing-kit": {
    id: "fishing-kit", name: "Fishing Line & Hooks", kind: "tool", tier: "common", value: 16, weight: 1,
  ...
  "snare-wire": {
    id: "snare-wire", name: "Snare Wire", kind: "tool", tier: "common", value: 18, weight: 1,
  ...
  "spyglass": {
    id: "spyglass", name: "Spyglass", kind: "tool", tier: "uncommon", value: 280, weight: 1,
  ...
  "manacles": {
    id: "manacles", name: "Iron Manacles", kind: "tool", tier: "common", value: 50, weight: 3,
  ...
  "healers-kit": {
    id: "healers-kit", name: "Field Surgeon's Kit", kind: "tool", tier: "uncommon", value: 180, weight: 2,
  ...
  "chalk-and-charcoal": {
    id: "chalk-and-charcoal", name: "Chalk & Charcoal", kind: "tool", tier: "common", value: 4, weight: 1,

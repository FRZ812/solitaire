...
const LEGACY_FACTIONS = [
  ...
  },
  {
    ...
    short: "Heron",
    color: "#4A6E8A",
    description: "A loose lineage of sorcerers descending from the Glass Spire — masters who keep their own spires, take occasional apprentices, and exchange letters and grimoires by herald-bird. The Heron Seat in the Spine Foothills is the only Heron seat in walking distance of the Vale.",
  },
  {

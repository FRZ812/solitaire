...
export const REGION_DEFINITIONS = {
  ...
  "whitemarch-march": {
    ...
    features: ["toll-fort", "quarry", "signal-spire", "fairground"],
  },
  "spine-foothills": {
  ...
  "iron-plateau": {
    ...
    features: ["manor-fort", "horse-fair", "signal-spire", "stone-village"],
  },
  "tellmar-road": {
...
export const SITE_MOTIFS = Object.freeze({
  ...
  "fortress-ruin": Object.freeze({ family: "ruin", terrains: Object.freeze(["hills", "plains", "mountains"]), description: "A curtain wall and one broken spire remain of a fortress that commanded this ground for someone." }),
  ...
  "signal-spire": Object.freeze({ family: "fortification", terrains: Object.freeze(["hills", "plains", "mountains"]), description: "A spire built for line of sight to the next spire, with a beacon on the roof and fuel stacked below." }),
  ...
  "watch-pagoda": Object.freeze({ family: "fortification", terrains: Object.freeze(["reedfield", "marsh"]), description: "A tiered timber spire on piles, each storey stepping in, giving sight over reed too tall to see across." }),
...
export const CAMPAIGN_MINOR_SITE_FEATURES = Object.freeze([
  ...
  Object.freeze({ kind: "frontier-fort", family: "fortification", description: "A timber and earth fort holding a stretch of border, with a ditch, a gate spire, and a small garrison." }),
]);
...
export const LANDMARKS = [
  ...
  { id: "heron-seat", name: "The Heron Seat", knowledge: "rumor", kind: "spire", coord: { x: 135, y: 40 }, regionId: "spine-foothills", realmId: "central", direction: "east", description: "A white-heralded sorcerer's spire watching the roads that converge on Reedwatch." },
  ...
  { id: "lotusmouth", name: "Lotusmouth", knowledge: "legend", kind: "port", coord: { x: 486, y: 94 }, regionId: "tellmar-road", realmId: "east", provinceId: "heron-inlet", factionId: "lotus-prefecture", routeIds: ["crown-road-east", "lotus-circuit"], direction: "far east", coastalFeatureId: "heron-inlet", description: "A bright harbor of stilt quays and red beacon spires where the Sea of Reeds opens into the Lantern Sea." },
  { id: "moon-reed-monastery", name: "Moon-Reed Monastery", knowledge: "legend", kind: "temple", coord: { x: 330, y: 145 }, regionId: "tellmar-road", realmId: "east", provinceId: "lotus-marches", factionId: "lotus-prefecture", routeIds: ["crown-road-east", "star-road", "jade-causeway"], direction: "far east", description: "A terraced river monastery whose bell spires rise above a horizon of reeds." },
  ...
  { id: "glass-dune-observatory", name: "Glass Dune Observatory", knowledge: "legend", kind: "spire", coord: { x: -30, y: 280 }, regionId: "hollow-coast", realmId: "south", provinceId: "glass-desert", factionId: "asalan-sun-court", routeIds: ["south-road", "dune-circuit"], direction: "far south", description: "A brass-domed observatory standing where lightning fused a dune into dark glass." },
  ...
  { id: "hanori", name: "Hanori", knowledge: "legend", kind: "city", role: "provincial-seat", coord: { x: 270, y: 65 }, regionId: "tellmar-road", realmId: "east", provinceId: "lotus-marches", factionId: "lotus-prefecture", routeIds: ["jade-causeway"], direction: "far east", description: "A raised canal city of floodgate spires, civil academies, tea courts, and the prefecture archives of the Lotus Marches." },
...
export const CONTINENT_ROUTES = [
  ...
  },
  {
    ...
    description: "A raised flood road of stone locks, courier spires, and academy hostels.",
  },
  {
  ...
  },
  {
    ...
    description: "A royal caravan road supplied by nine protected wells and mirrored signal spires.",
  },
  {

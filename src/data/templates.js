...
export const TEMPLATE_BRANCH_CHOICES = Object.freeze({
  ranger: Object.freeze({ "ranger-field-practice": "hunter" }),
  "beast-warden": Object.freeze({ "ranger-field-practice": "beast-warden", "beast-warden-method": "packmaster" }),
  cutthroat: Object.freeze({ "rogue-practice": "assassin" }),
  "knight-errant": Object.freeze({ "paladin-oath": "beacon-oath" }),
  ...
  shadowblade: Object.freeze({ "rogue-practice": "infiltrator", "rogue-infiltrator-method": "crowd-ghost", "wizard-school": "illusion" }),
  "champion-paladin": Object.freeze({ "paladin-oath": "shield-oath", "paladin-shield-method": "shieldbearer", "warrior-specialization": "iron-vanguard" }),
  "dragon-hunter": Object.freeze({ "ranger-field-practice": "hunter", "hunter-method": "monster-stalker", "warrior-specialization": "iron-vanguard" }),
...
const CHARACTER_TEMPLATE_DEFINITIONS = [
  ...
  },
  {
    ...
    setup: {
      ...
      abilities: [{ id: "ranger-quarry-sign", tier: "common" }, { id: "ranger-ranging-shot", tier: "uncommon" }, { id: "ranger-patient-aim", tier: "uncommon" }],
  ...
  },
  {
    ...
    setup: {
      ...
      abilities: [{ id: "rogue-assess-mark", tier: "common" }, { id: "rogue-testing-cut", tier: "uncommon" }, { id: "rogue-slip-the-line", tier: "uncommon" }, { id: "rogue-killing-measure", tier: "uncommon" }],
  ...
  },
  {
    ...
    setup: {
      ...
      abilities: [{ id: "paladin-oathguard", tier: "uncommon" }, { id: "paladin-vowed-strike", tier: "uncommon" }, { id: "paladin-stand-fast", tier: "rare" }, { id: "paladin-challenge-of-witness", tier: "rare" }, { id: "paladin-beacon-stance", tier: "rare" }],
  ...
  },
  {
    ...
    setup: {
      ...
      abilities: [{ id: "ranger-quarry-sign", tier: "rare" }, { id: "ranger-ranging-shot", tier: "rare" }, { id: "ranger-field-dressing", tier: "uncommon" }, { id: "ranger-trail-cut", tier: "uncommon" }, { id: "ranger-pinpoint-volley", tier: "rare" }, { id: "ranger-companion-signal", tier: "rare" }, { id: "ranger-pack-command", tier: "rare" }],
  ...
  },
  {
    ...
    setup: {
      ...
      abilities: [{ id: "rogue-assess-mark", tier: "epic" }, { id: "rogue-testing-cut", tier: "epic" }, { id: "rogue-slip-the-line", tier: "epic" }, { id: "rogue-false-opening", tier: "epic" }, { id: "rogue-exploit-guard", tier: "epic" }, { id: "rogue-silent-entry", tier: "epic" }, { id: "rogue-crowd-ghost", tier: "epic" }],
  ...
  },
  {
    ...
    role: "Protector",
    tier: "epic",
    concept: "An oathbound champion — bears the blow and keeps the covenant.",
    ...
    setup: {
      ...
      abilities: [{ id: "paladin-oathguard", tier: "epic" }, { id: "paladin-vowed-strike", tier: "epic" }, { id: "paladin-stand-fast", tier: "epic" }, { id: "paladin-challenge-of-witness", tier: "epic" }, { id: "paladin-bear-the-blow", tier: "epic" }, { id: "paladin-steadfast-word", tier: "epic" }, { id: "paladin-shield-covenant", tier: "epic" }, { id: "paladin-rampart-exchange", tier: "epic" }],
  ...
  // =========================== LEGENDARY ===========================
  {
    ...
    setup: {
      ...
      abilities: [{ id: "ranger-quarry-sign", tier: "legendary" }, { id: "ranger-ranging-shot", tier: "legendary" }, { id: "ranger-field-dressing", tier: "legendary" }, { id: "ranger-trail-cut", tier: "legendary" }, { id: "ranger-pinpoint-volley", tier: "legendary" }, { id: "ranger-evading-step", tier: "legendary" }, { id: "ranger-patient-aim", tier: "legendary" }, { id: "ranger-read-monster", tier: "legendary" }],
  ...
  },
  {
    ...
    role: "Skirmisher",
    tier: "legendary",
    concept: "A returned fae debtor who makes every price and double meaning cut both ways.",
    story: "Niamh came back from the Fae bargain still mostly herself, which is rarer than surviving it. She survived by learning to trade whispers, conditions, and exact reciprocal terms more carefully than any fae court expected.",
    ...
    setup: {
      ...
      abilities: [
        { id: "warlock-tithe-bolt", tier: "legendary" }, { id: "warlock-debt-mark", tier: "legendary" },
        { id: "warlock-favors-rebuke", tier: "legendary" }, { id: "warlock-open-covenant", tier: "legendary" },
        { id: "warlock-owed-ward", tier: "legendary" }, { id: "warlock-covenant-lash", tier: "legendary" },
        { id: "warlock-creditors-gaze", tier: "legendary" }, { id: "warlock-claim-due", tier: "legendary" },
        { id: "warlock-whispered-terms", tier: "legendary" }, { id: "warlock-open-bargain", tier: "legendary" },
      ],
  ...
  },
  {
    ...
    role: "Warlock",
    tier: "mythical",
    concept: "An impish northern demon prince who smiles while binding debts and hells.",
    story: "The youngest prince of a demonborn house beneath the Frostcrown, Vesh learned court ceremony before infernal names. He meets ancient horrors with the bright, insolent smile of a favoured son certain the room belongs to him, then closes the clause around them before anyone notices what price he paid.",
    highlights: ["Mind", "Presence"],
    setup: {
      name: "Vesh Kethran",
      profession: "warlock",
      ...
      abilities: [
        { id: "warlock-tithe-bolt", tier: "mythical" }, { id: "warlock-debt-mark", tier: "mythical" },
        { id: "warlock-favors-rebuke", tier: "mythical" }, { id: "warlock-open-covenant", tier: "mythical" },
        { id: "warlock-owed-ward", tier: "mythical" }, { id: "warlock-covenant-lash", tier: "mythical" },
        { id: "warlock-creditors-gaze", tier: "mythical" }, { id: "warlock-claim-due", tier: "mythical" },
        { id: "warlock-ruinous-terms", tier: "mythical" }, { id: "warlock-fivefold-collection", tier: "mythical" },
        { id: "warlock-hellfire-covenant", tier: "mythical" }, { id: "warlock-devils-due", tier: "mythical" },
      ],

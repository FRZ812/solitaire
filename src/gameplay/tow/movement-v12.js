...
// Deterministic round-boundary reflow for moving (formation rules v2) Tower fights.
//
...
import { abilityTargeting } from "./ability-targeting-v12.js";
import {
  MOVING_FORMATION_RULES_VERSION,
  formationRow,
} from "./formation.js";
import { getSkill } from "./skills-v12.js";
 ...
 */
export function reflowTowFormations(state) {

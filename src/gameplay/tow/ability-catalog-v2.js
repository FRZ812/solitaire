// Explicit opt-in party catalogue for solitaire-tow-v2.
//
...
export const TOW_ABILITY_CATALOG_V2_VERSION = 1;
...
export const TOW_ABILITY_STATUSES_V2 = defineStatusRulesV2Registry(AUTHORED_STATUSES_V2);
export const TOW_ABILITY_STATUS_LIST_V2 = deepFreeze(Object.values(TOW_ABILITY_STATUSES_V2));
...
export const TOW_ABILITY_ZONES_V2 = defineZoneRulesV2Registry(AUTHORED_ZONES_V2);
...
export const TOW_DEFAULT_ABILITY_KITS_V2 = deepFreeze({
  ...
  artificer: ["clocktower-fire", "clocktower-suppressive-shot", "clocktower-grappling-hook", "clocktower-tailored-drink", "clocktower-ultra-barrier"],
...
export const TOW_ABILITY_NAMES_V2 = deepFreeze({
  ...
  "clocktower-fire": "Fire!",
  "clocktower-suppressive-shot": "Suppressive Shot",
...
export const TOW_ABILITY_ROLES_V2 = deepFreeze({
  ...
  "clocktower-fire": ["damage"],
  "clocktower-suppressive-shot": ["tank-control"],
  "clocktower-grappling-hook": ["tank-control", "tempo"],
  "clocktower-tailored-drink": ["heal", "buff", "tempo"],
  "clocktower-ultra-barrier": ["tank-control", "buff"],
...
export const TOW_ABILITY_CATALOG_V2 = defineCatalog(AUTHORED_ABILITIES_V2);
export const TOW_ABILITY_CATALOG_V2_LIST = deepFreeze([...AUTHORED_ABILITIES_V2]);
export const TOW_ABILITY_ZONE_LIST_V2 = deepFreeze(Object.values(TOW_ABILITY_ZONES_V2));

export function getTowAbilityRulesV2(id) {
  return typeof id === "string" && Object.hasOwn(TOW_ABILITY_CATALOG_V2, id)
    ? TOW_ABILITY_CATALOG_V2[id]
    : null;
}

export function getTowAbilityNameV2(id) {
  return typeof id === "string" && Object.hasOwn(TOW_ABILITY_NAMES_V2, id)
    ? TOW_ABILITY_NAMES_V2[id]
    : null;
}

export function getTowAbilityRolesV2(id) {
  return typeof id === "string" && Object.hasOwn(TOW_ABILITY_ROLES_V2, id)
    ? TOW_ABILITY_ROLES_V2[id]
    : null;
}

export function getTowStatusRulesV2(id) {
  return typeof id === "string" && Object.hasOwn(TOW_ABILITY_STATUSES_V2, id)
    ? TOW_ABILITY_STATUSES_V2[id]
    : null;
}

export function getTowDefaultAbilityKitV2(archetypeId) {
  return typeof archetypeId === "string"
    && Object.hasOwn(TOW_DEFAULT_ABILITY_KITS_V2, archetypeId)
    ? TOW_DEFAULT_ABILITY_KITS_V2[archetypeId]
    : null;
}
...
export function calculateTowAbilityCatalogV2Checksum() {
  return `fnv1a32:${fnv1a32(stableSerialize({
    version: TOW_ABILITY_CATALOG_V2_VERSION,
    kits: TOW_DEFAULT_ABILITY_KITS_V2,
    names: TOW_ABILITY_NAMES_V2,
    roles: TOW_ABILITY_ROLES_V2,
    statuses: TOW_ABILITY_STATUS_LIST_V2,
    abilities: TOW_ABILITY_CATALOG_V2_LIST,
    zones: TOW_ABILITY_ZONE_LIST_V2,
  }))}`;
}
...
export const TOW_ABILITY_CATALOG_V2_CHECKSUM = "fnv1a32:8a8adfc6";

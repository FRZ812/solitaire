// Read-only tactical metadata for the captured Tower ability catalogue.
//
...
const DISPEL_ABILITY_IDS = new Set([
  "assassin-cold-blood",
  "clocktower-armor-piercing-round",
  "witch-nullification",
]);
 ...
 */
export function abilityProfile(skillOrId, rank = 1, { rulesetId = TOW_RULESET_ID } = {}) {
  if (rulesetId !== TOW_RULESET_ID) throw new TypeError(`unsupported-ability-ruleset:${rulesetId}`);
  const definition = definitionFor(skillOrId);

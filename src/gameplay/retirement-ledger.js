...
export const RETIREMENT_LEDGER = Object.freeze([
  ...
  entry("kernel/combat-actor.js", DESTINATION.KEEP, {
    why: "The live actor model, carrying crit, dodge and a shield pool separate from HP.",
  }),
  entry("kernel/combat-damage.js", DESTINATION.KEEP, {
  ...
  entry("kernel/intent.js", DESTINATION.PORT, {
    successor: "src/gameplay/combat/intent.js",
    blockedBy: "phase-3-intent-harness",
    why: "Seeded, versioned, embeddable intent pattern machine with a schedule that can be "
      + "re-derived to prove it was not tampered with. COMBAT picks attacks at random today, "
  ...
  entry("kernel/model.js", DESTINATION.DELETE, {
    ...
    why: "1v1-capped actor/encounter model with no crit, dodge, shield or multi-hit. "
      + "Superseded by combat-actor.js plus combat/encounter.js.",
  }),
  entry("kernel/resolve.js", DESTINATION.DELETE, {
    blockedBy: "kernel/intent.js port",
    why: "Single-action-per-round resolver superseded by combat/encounter.js. Holds the intent "
  ...
  entry("production/combat-adapter.js", DESTINATION.DELETE, {
    ...
    why: "1v1-only admission superseded by combat/solitaire-bridge.js, which admits groups.",
  }),
  ...
  entry("production/combat-settlement.js", DESTINATION.DELETE, {
    blockedBy: "app-import",
    why: "Single-foe settlement superseded by combat/settlement.js, which settles a group and "
      + "emits a growth beat.",
  }),
  ...
  ...[
    ["reference/policy.js", "Provisional policy object; its evidence now lives in docs/design/COMBAT_EVIDENCE.md."],
    ...
    ["reference/skills.js", "Two skills with per-encounter uses, superseded by combat/skills.js."],
    ["reference/abilities.js", "Trait metadata with no effects; nothing fires it in combat."],
    ["reference/actions.js", "Basic attack/defence actions superseded by combat/skills.js."],
  ...
  entry("run/persistence.js", DESTINATION.PORT, {
    ...
    why: "Versioned, baseline-tagged, fingerprinted save envelope with tamper detection. "
      + "A live fight is lost on reload today because nothing plays this role for COMBAT.",
  }),
  entry("run/rewards.js", DESTINATION.PORT, {
    successor: "the COMBAT reward loop",
  ...
  entry("run/action-progression.js", DESTINATION.PORT, {
    successor: "COMBAT build progression",
    blockedBy: "phase-8-rewards",
    why: "Per-slot family lock and upgrade levels. combat/skills.js has a `replaces` field "
  ...
  entry("run/build.js", DESTINATION.DELETE, {
    ...
    why: "Reference build composition superseded by the Phase 1 durable CombatPlayerBuild.",
  }),
]);

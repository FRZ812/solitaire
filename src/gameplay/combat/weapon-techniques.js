...
import { itemCombatStats, weaponCategory } from "../../engine/combat-stats.js";
...
function activeFormFor(lineage_, item, requestedFormId) {
  const desired = requestedFormId || item?.combatAttackFormId || lineage_.activeFormId;
...
export function weaponTechniqueForEquippedItem(itemId, codex = {}) {
  ...
  return weaponTechniqueFromItemIds(itemId ? [itemId] : [], codex, {
    formId: item?.combatAttackFormId,
  });
}

...
export const COMBAT_ABILITY_RULES_V2_VERSION = 2;
export const COMBAT_ABILITY_RANK_MAX_V2 = 6;
...
function validationReason(value) {
  ...
  if (value.version !== COMBAT_ABILITY_RULES_V2_VERSION) return "invalid-ability-rules-v2-version";
  if (value.rulesetId !== COMBAT_ABILITY_RULESET_V2_ID) return "invalid-ability-rules-v2-id";
  if (!identifier(value.id)) return "invalid-ability-rules-v2-ability-id";
  if (!Number.isSafeInteger(value.rankCount)
    || value.rankCount < 1
    || value.rankCount > COMBAT_ABILITY_RANK_MAX_V2) {
...
function zoneValidationReason(value) {
  ...
  if (value.version !== COMBAT_ABILITY_RULES_V2_VERSION) return "invalid-zone-rules-v2-version";
  if (value.rulesetId !== COMBAT_ABILITY_RULESET_V2_ID) return "invalid-zone-rules-v2-id";

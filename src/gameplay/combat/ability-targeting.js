...
export const ALLY_TARGET_ABILITY_IDS = Object.freeze([
  ...
  "artificer-high-voltage",
  "artificer-ultra-barrier",
  "artificer-improvement",
  "artificer-preparation",
  "artificer-tailored-drink",
  "artificer-reinforcement",
  "artificer-redesign",
...
const FOOTPRINT_BY_ID = Object.freeze({
  ...
  "artificer-missile-support": "column",
  ...
  "artificer-grenade-toss": "cross-short",
  ...
  "artificer-chain-explosion": "cross-full",
  "artificer-electromagnetic-field": "cross-full",
  "artificer-ultra-barrier": "cross-full",
...
const PROJECTILE_CAST_IDS = new Set([
  ...
  "artificer-grenade-toss",
  "artificer-missile-support",

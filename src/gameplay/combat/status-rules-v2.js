// Immutable status semantics for solitaire-combat-v2.
//
...
function validationReason(value) {
  ...
  if (value.version !== COMBAT_ABILITY_RULES_V2_VERSION) return "invalid-status-rules-v2-version";
  if (value.rulesetId !== COMBAT_ABILITY_RULESET_V2_ID) return "invalid-status-rules-v2-id";

...
import { attrFactor } from "../data/abilities-v13.js";
import { tierMult, tier as tierInfo } from "../data/tiers.js";
import { aggregateCombatPassives, aggregateWorldPassives, passiveDef, PASSIVE_CAPS } from "../data/passives-v13.js";
import { attributeThresholdMods, mechanicalAttributeValue } from "../data/attribute-tiers-v13.js";
import { progressionPassiveEntries } from "./progression-abilities-v13.js";
...
export function collectEquippedPassives(character, codex) {
  ...
  // Tower archetypes derive combat identity from their formation kit. Keep a

...
import { ArchetypeCombatView } from "./ArchetypeCombatView.jsx";
import { buildCombatChronicle, renderCombatChronicle } from "../../gameplay/combat/chronicle.js";
import { compileCharacterBootstrap } from "../../gameplay/combat/character-bootstrap.js";
import { declaredIntents } from "../../gameplay/combat/encounter.js";
import {
  PRACTICE_SCENARIOS,
...
import {
  ...
  encodeCombatRuntimeSession,
  sealCombatRuntimeTerminalReceipt,
  combatRuntimeSessionEvents,
  verifyCombatRuntimeSession,
} from "../../gameplay/combat/runtime.js";
import { startingPackageIds } from "../../gameplay/combat/starting-packages.js";
...
export function exportLabFixture(session) {
  const encoded = encodeCombatRuntimeSession(session);
...
export function importLabFixture(json) {
  ...
  return decodeCombatRuntimeSession(parsed);
}
...
export function CombatLab({ onExit }) {
  ...
  const verification = verifyCombatRuntimeSession(session);
  const projectedEvents = combatRuntimeSessionEvents(session);

...
const ICONS = {
  ...
  play: <path d="M7 4.8v14.4a1 1 0 0 0 1.55.83l10.8-7.2a1 1 0 0 0 0-1.66l-10.8-7.2A1 1 0 0 0 7 4.8Z"/>,
  heart: <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/>,
  flame: <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"/>,
  sun: <><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></>,
  eye: <><path d="M2.06 12.35a1 1 0 0 1 0-.7C3.73 7.6 7.65 5 12 5s8.27 2.6 9.94 6.65a1 1 0 0 1 0 .7C20.27 16.4 16.35 19 12 19s-8.27-2.6-9.94-6.65Z"/><circle cx="12" cy="12" r="3"/></>,
  eyeOff: <><path d="M10.73 5.08A10.7 10.7 0 0 1 12 5c4.35 0 8.27 2.6 9.94 6.65a1 1 0 0 1 0 .7 10.7 10.7 0 0 1-2.18 3.32"/><path d="M6.61 6.61a10.66 10.66 0 0 0-4.55 5.04 1 1 0 0 0 0 .7C3.73 16.4 7.65 19 12 19c1.13 0 2.22-.18 3.24-.5"/><path d="M9.88 9.88A3 3 0 0 0 14.12 14.12"/><path d="m3 3 18 18"/></>,
  ...
  bagOpen: <><path d="M4 10h16l-1.2 10H5.2z"/><path d="m4 10 3-5h10l3 5"/><path d="m8 5-2-3"/><path d="m16 5 2-3"/><path d="M8 10c.4 2 1.8 3 4 3s3.6-1 4-3"/></>,
  ...
  zoomIn: <><circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3"/><path d="M8 11h6"/><path d="M11 8v6"/></>,
